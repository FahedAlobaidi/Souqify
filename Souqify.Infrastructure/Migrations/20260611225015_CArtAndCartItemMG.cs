...
{
    /// <inheritdoc />
    public partial class CArtAndCartItemMG : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceAtAdd = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    AddedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartItem", x => x.Id);
                    table.CheckConstraint("CK_Quantity_MoreThanZero", "\"Quantity\" > 0");
                    table.ForeignKey(
