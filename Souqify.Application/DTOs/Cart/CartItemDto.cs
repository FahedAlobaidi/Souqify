...
namespace Souqify.Application.DTOs.Cart
{
    public class CartItemDto
    {
        ...
        public bool PriceChanged => PriceAtAdded != CurrentPrice;//this to check if (CurrentPrice and PriceAtAdded) changed or not
        ...
        public bool ExceedsStock => Quantity > AvailableStock; // to check if the variant quantity is more than what user needs
        public decimal lineTotal => CurrentPrice * Quantity; //how much the price that the cart item line has (current  * quantity)
